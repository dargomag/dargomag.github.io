---
layout: default
title: "Физика — второй месяц календаря Дарго"
---
...
<div class="nav">
  <a href="https://dargomag.github.io/calendar/mathematics.html">← Математика</a>
...
<div class="page-header">
  ...
  <div class="month-title">Физика — второй месяц календаря</div>
  <div class="month-subtitle">(22 января — 20 февраля по григорианскому календарю)</div>
</div>
...
<div class="calendar-body">
  ...
  <div class="left-panel">
    <div class="left-text">
      <p>Изначальное значение слова «физика» — Вселенная. Сегодня физика — наука об
      основополагающих законах и свойствах окружающей нас Вселенной.</p>
      <p>Физика изучает взаимодействия творений Бога без превращения их состава.
      Путь современной физики: наблюдение — гипотеза — теория — эксперимент.</p>
      <p>Математика — язык Бога, а физика с химией — его слово.</p>
    </div>
    <div class="left-footer">I квартал · 30 дней</div>
  </div>
...
(function () {
  ...
  var WEEK_START    = 5;   // первая неделя этого месяца
  var START_DOW     = 3;   // смещение: 0=ПН,1=ВТ,2=СР,3=ЧТ,4=ПТ,5=СБ,6=ВС
  var GREG_START_D  = 22;
  var GREG_START_M  = 1;   // январь
  ...
  for (var row = 0; row < 5; row++) {
    ...
    for (var col = 0; col < 7; col++) {
      var cell = document.createElement('div');
      // первая строка: пустые ячейки до START_DOW
      var isLeadingEmpty = (row === 0 && col < START_DOW);
      // ячейки после последнего дня
