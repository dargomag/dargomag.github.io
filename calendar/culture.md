---
layout: default
title: "Культура — десятый месяц календаря Дарго"
---
...
<div class="page-header">
  ...
  <div class="month-title">Культура — десятый месяц календаря</div>
  <div class="month-subtitle">(21 сентября — 21 октября по григорианскому календарю)</div>
</div>
...
<div class="calendar-body">
  ...
  <div class="left-panel">
    <div class="left-text">
      <p>У каждого народа, у каждого сообщества свои правила поведения, которые в общем
      называются Культурой. Эти правила вырабатываются многими веками в ходе взаимодействия
      и с окружающей средой, климатом, и с окружающими людьми.</p>
      <p>Культура делает человека Человеком. Культура, она же духовность, вырабатывается
      самими людьми и, в некотором смысле, противостоит их животной природе, направлена
      на её усовершенствование.</p>
    </div>
    <div class="left-footer">Культура · 31 день</div>
  </div>
